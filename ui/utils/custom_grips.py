...
class CustomGrip(QWidget):
    def __init__(self, parent, position, disable_color=False):
        ...
        if position == Qt.TopEdge:
            self.wi.top(self)  # 创建顶部 grip 控制点
        ...
        # 显示左侧控制点
            ...
            self.wi.left(self)  # 创建左侧 grip 控制点
        ...
        # 显示右侧控制点
            ...
            self.wi.right(self)  # 创建右侧 grip 控制点
